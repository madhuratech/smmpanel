...
export default function BuyTikTokLikes() {
  ...
  useEffect(() => {
    document.title = "Buy TikTok Likes | Affordable Price | Real Growth";
    ...
    metaDesc.setAttribute('content', 'Ranked #1 service in 2026. TikyTop offers the best packages where you can customize and buy TikTok likes that is without providing your personal information.');
    ...
    metaKeywords.setAttribute('content', 'Buy tiktok likes, how to buy tiktok likes, how to get more tiktok likes, buy tiktok likes and views, buy likes on tiktok, tiktok likes buy, buy real tiktok likes, buy cheap tiktok likes, how to buy likes on tiktok, best place to buy tiktok likes, buy 50 tiktok likes');
  }, []);
    ...
    <div className=" text-white font-sans antialiased overflow-x-hidden">
      ...
      <section className="py-24 px-6 bg-white overflow-hidden relative text-gray-900">
        ...
        <div
          ...
          className="flex overflow-x-auto gap-6 pb-12 cursor-grab select-none no-scrollbar scroll-smooth"
