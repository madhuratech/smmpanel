  ...
  return (
    <div className="section-spacing relative overflow-hidden">
      ...
      <div className="global-container relative z-10">
        ...
        {/* Main CTA Card */}
        <div className="bg-white/60 backdrop-blur-xl global-card border border-white/70 text-center flex flex-col items-center">

          <h2 className="section-heading text-black mb-6 leading-tight">
            Ready to Take the Spotlight on Social Media?
          </h2>

          <p className="global-paragraph text-gray-800 mb-8 leading-relaxed max-w-3xl mx-auto">
          ...
          <p className="global-paragraph text-gray-700 mb-10 max-w-3xl mx-auto">
